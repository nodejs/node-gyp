  ...
  """
    ...
    """
        ...
        try:
            ...
            nnabt.common.ExceptionAppend(e, 'while printing key "%s"' % key)
            raise
...
class XCHierarchicalElement(XCObject):
  ...
  project file."""
    ...
    def CompareRootGroup(self, other):
        ...
        # listed order.
        # TODO(mark): "Build" is used by nnabt.generator.xcode, perhaps the
    ...
    def __init__(self, properties=None, id=None, parent=None):
        ...
        if (
            ...
            prop_map = {
                ...
                "nnabt": "explicitFileType",
                "nnabti": "explicitFileType",
            }
        ...
        if path_tree_match:
            ...
            if path_tree in self.path_tree_first_to_subfolder:
                ...
                if subfolder == 16 and path_tree_match.group(4) is not None:
                    ...
                    # variables to relative paths so .nnabt files must prefix them with
                    ...
                    # to match to the subfolder indices in the second table. .nnabt files
                    ...
                    # this same way could be used to specify destinations in .nnabt files
...
class PBXContainerItemProxy(XCObject):
    ...
    def __repr__(self):
        ...
        name = "%s.nnabt:%s" % (props["containerPortal"].Name(), props["remoteInfo"])
        return "<%s %r at 0x%x>" % (self.__class__.__name__, name, id(self))
...
class PBXNativeTarget(XCTarget):
    ...
    _product_filetypes = {
        ...
        "com.googlecode.nnabt.xcode.bundle": ["compiled.mach-o.dylib", "", ".so"],
    ...
    def __init__(
        ...
        if (
            ...
            if products_group is not None:
                ...
                # com.googlecode.nnabt.xcode.bundle.
                #
                ...
                if self._properties["productType"] == "com.googlecode.nnabt.xcode.bundle":
                    self._properties[
                        "productType"
                    ] = "com.apple.product-type.library.dynamic"
                ...
                #    http://code.google.com/p/nnabt/issues/detail?id=122
...
class PBXProject(XCContainerPortal):
  ...
  """
    ...
    """
        ...
        # nnabt.generator.xcode.  There should probably be some way for that module
    ...
    """
        ...
        if other_pbxproject not in self._other_pbxprojects:
            ...
            other_path = nnabt.common.RelativePath(other_pbxproject.Path(), this_path)
