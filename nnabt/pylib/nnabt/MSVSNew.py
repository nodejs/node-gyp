...
class MSVSProject(MSVSSolutionEntry):
    ...
    Args:
      ...
      build_file: Filename of the .nnabt file that the vcproj file comes from.
...
class MSVSSolution(object):
    ...
    def Write(self, writer=nnabt.common.WriteOnDiff):
    ...
    """
        ...
        for e in all_entries:
            relative_path = nnabt.common.RelativePath(e.path, sln_root)
