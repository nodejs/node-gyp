...
class TargetCalculator(object):
    ...
    def __init__(
        ...
        self._name_to_target, self._changed_targets, self._root_targets = _GenerateTargets(
            data, target_list, target_dicts, toplevel_dir, frozenset(files), build_files
        )
        self._unqualified_mapping, self.invalid_targets = _GetUnqualifiedToTargetMapping(
