...
PythonFinder.prototype = {
  ...
  winDefaultLocations: [
    ...
    path.join(process.env.SystemDrive || 'C:', 'Program Files', 'Python39-32', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Program Files (x86)', 'Python39-32', 'python.exe'),
    ...
    path.join(process.env.SystemDrive || 'C:', 'Program Files', 'Python38-32', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Program Files (x86)', 'Python38-32', 'python.exe'),
    ...
    path.join(process.env.SystemDrive || 'C:', 'Program Files', 'Python37-32', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Program Files (x86)', 'Python37-32', 'python.exe'),
    ...
    path.join(process.env.SystemDrive || 'C:', 'Program Files', 'Python36-32', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Program Files (x86)', 'Python36-32', 'python.exe')
  ],
