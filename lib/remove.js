...
function remove (nnabt, argv, callback) {
  var devDir = nnabt.devDir
  log.verbose('remove', 'using node-nnabt dir:', devDir)

  // get the user-specified version to remove
  var version = argv[0] || nnabt.opts.target
  ...
  var versionPath = path.resolve(nnabt.devDir, version)
