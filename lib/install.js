...
function install (gyp, argv, callback) {
  ...
  function go () {
    ...
    mkdir(devDir, function (err, created) {
      ...
      var tarUrl = gyp.opts['tarball-url'] || gyp.opts.tarballurl;
      var tarballUrl = tarUrl ? tarUrl : distUrl + '/v' + version + '/node-v' + version + '.tar.gz'
        , badDownload = false
        , extractCount = 0
      ...
      if (tarballUrl.indexOf("http://")!=0 && tarballUrl.indexOf("https://")!=0) {
