...
function lessThan (version, major, minor) {
  var inMaj = parseInt(version[1], 10)
    , inMin = parseInt(version[2], 10)
...
function install (gyp, argv, callback) {
  ...
  var isLegacy = lessThan(version, 0, 8)
  gyp.verbose('installing legacy version?', isLegacy)

  if (lessThan(version, 0, 6)) {
